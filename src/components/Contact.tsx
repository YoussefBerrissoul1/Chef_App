...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const whatsappNumber = '212613516173'; // Remplace par ton numéro sans le "+".
    const text = `مرحباً، اسمي ${name}، ورقمي هو ${phone}، وهذه رسالتي: ${message}`;
    ...
    <section id="contact" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">لا تترددوا في التواصل معي لأي استفسار أو طلب خاص</p>
        </div>

        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-amber-50 to-rose-50 rounded-2xl p-8 shadow-lg">
              <h3 className="text-2xl font-semibold text-gray-800 mb-6 text-right">معلومات الاتصال</h3>
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4 space-x-reverse">
                  ...
                  <div className="text-right">
                    ...
                    <a href="tel:+212613516173" className="text-gray-600 hover:text-green-600 transition-colors">+212 613-516173</a>
                  </div>
                </div>
                <div className="flex items-center space-x-4 space-x-reverse">
            ...
            <div className="bg-gradient-to-br from-rose-50 to-amber-50 rounded-2xl p-8 shadow-lg">
              <h4 className="text-xl font-semibold text-gray-800 mb-4 text-right">ساعات العمل</h4>
              <div className="space-y-2 text-right">
                <p className="text-gray-600"><span className="font-medium">الإثنين - الجمعة:</span> 9:00 - 19:00</p>
                <p className="text-gray-600"><span className="font-medium">السبت:</span> 9:00 - 17:00</p>
                <p className="text-gray-600"><span className="font-medium">الأحد:</span> بالموعد المسبق</p>
              </div>
            </div>
          </div>

          <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-8 shadow-lg">
            <h3 className="text-2xl font-semibold text-gray-800 mb-6 text-right">أرسل رسالة</h3>
